...
export class ProjectsComponent {
  ...
  projects: ProjectInfo[] = [
    ...
    {name: 'Workout Tracker', description: 'Keep track of your workout routines and goals with this minimal web app.', image: '', stack: ['Spring Boot', 'Kotlin', 'Angular'], url: 'https://github.com/tinasche/workit'},
